...
% Podemos dar una lista de las definiciones principales y dem�s
...
%\begin{eje}: Calcular el m\'{a}ximo de una lista de $n$ enteros $a_1,\ldots,a_n$
%
%        \begin{quotation}
%            $\bolds{a:= a_1}$;\\
%            $\bolds{i:= 1}$;\\
%            \textsf{Mientras} $\bolds{i \leq n-1}$ \textsf{haz}\\
%            \hspace*{0.5cm} $\bolds{i:= i+1}$;\\
%            \hspace*{0.5cm} \textsf{Si} $\bolds{a < a_i}$ \textsf{entonces}
%            $\bolds{a:= a_i}$;\\
%
%            $\bolds{s:= a}$.
%        \end{quotation}
...
%
%        \begin{quotation}
%            $\bolds{a:= a_1}$; \hfill{1 asignaci\'{o}n}\\
%            $\bolds{i:= 1}$; \hfill{1 asignaci\'{o}n}\\
%            \textsf{Mientras} $\bolds{i \leq n-1}$ \textsf{haz} \hfill{1 resta}\\
%
% \noindent{\textrm{Entramos en un bucle que se repite $n-1$ veces}}\\
% \vspace{0.3cm}
%                \hfill{ 1 comparaci\'{o}n (i con $n-1$)}
%
%            \hspace*{0.5cm} $\bolds{i:= i+1}$; \hfill{1 asignaci\'{o}n y 1 suma}\\
%            \hspace*{0.5cm} \textsf{Si} $\bolds{a < a_i}$ \hfill{1 comparaci\'{o}n}\\
%            \textsf{entonces} $\bolds{a:= a_i}$;
...
%            $\bolds{s:= a}$. \hfill{1 asignaci\'{o}n}
%        \end{quotation}
%
%        $$\bolds{T(n)=3+5(n-1)+2=5n}$$
%
% \end{eje}
...
% \begin{eje} Producto de dos enteros positivos $m$ y $n$
%        \vfill
%        \begin{quotation}
%        $\bolds{x:=m}$\\
%        $\bolds{y:=n}$\\
%        $\bolds{z:=0}$;\\
%        \textsf{mientras} $\bolds{y>0}$ \textsf{haz}\\
%        \hspace*{0.5cm}$\bolds{z:=z+x}$\\
%        \hspace*{0.5cm}$\bolds{y:=y-1}$\\
%        $\bolds{s:=z}$
%        \end{quotation}
% \end{eje}
...
%        \vfill
%        \noindent $\bolds{a:=0;\, b:=n;\, c:=m}$\\[1ex]
%        \textsf{Mientras } $\bolds{b\neq 0}$ \textsf{ haz }\\[1ex]
%        \quad \textsf{Mientras } $\bolds{b}$ es par \textsf{ haz }\\[1ex]
%        \quad\quad $\bolds{b:=b/2;\, c:=2c}$\\[1ex]
%        \quad $\bolds{a:=a + c;\, b:=b - 1}$\\[1ex]
%        $\bolds{z:=a}$.
...
%        $\bolds{\azul{n=2^{k_1}+2^{k_1+k_2}+\cdots+2^{k_1+k_2+\cdots+k_p}}\,\,;\,\,\,\,k_1<k_2<\ldots<k_p}$
%        \noindent$\bolds{a_0=0;\,b_0=n; c_0=m}$
%        \medskip
...
%            \begin{itemize}
%                \item $\bolds{b \mbox{ es par ($k_1\neq0$)}}$\\
%                    \quad$\bolds{b\leftarrow b/2; c\leftarrow 2c \quad (k_1 \mbox{ veces })}$
%                \item $\bolds{b \mbox{ es impar ($k_1=0$)}}$
%            \end{itemize}
%            \quad$\bolds{a\leftarrow a+c; b\leftarrow b-1}$
%            \medskip

%            $\bolds{\left\{\begin{array}{l}
%            a_1=c_1=2^{k_1}m \\
...
%            \begin{itemize}
%                \item $\bolds{b \mbox{ es par ($k_2\neq0$)}}$\\
%                     \quad$\bolds{b\leftarrow b/2; c\leftarrow 2c \quad (k_2 \mbox{ veces })}$
%                %\item $\bolds{b \mbox{ es impar ($k_2=0$)}}$
%            \end{itemize}
%            \quad$\bolds{a\leftarrow a+c; b\leftarrow b-1}$
%            \medskip
...
%        \end{description}
%        \bigskip
%        $$\bolds{a_2+b_2c_2=a_1+2^{k_2}c_1+\left(b_1/2^{k_2}-1\right)2^{k_2}c_1=}$$
%        $$\bolds{=a_1+b_1c_1=nm}$$
...
%    \begin{description}
%        \item[\underline{Paso $\bolds{h-1:}$}]
%        $\bolds{a_{h-1}+b_{h-1}c_{h-1}=nm}$
%        \medskip
%        \item[\underline{Paso $\bolds{h:}$}] $\mbox{ }$
%        \begin{itemize}
%            \item $\bolds{b \mbox{ es par ($k_h\neq0$)}}$\\
%                \quad$\bolds{b\leftarrow b/2; c\leftarrow 2c \quad (k_h \mbox{ veces })}$
%            %\item $\bolds{b \mbox{ es impar ($k_h=0$)}}$\\
%        \end{itemize}
%        \quad$\bolds{a\leftarrow a+c; b\leftarrow b-1}$
%        \medskip
...
%    \end{description}
%    \bigskip
%    $$\bolds{a_h+b_hc_h=a_{h-1}+2^{k_h}c_{h-1}+\left(b_{h-1}/2^{k_h}-1\right)2^{k_h}c_{h-1}=}$$
%    $$\bolds{=a_{h-1}+b_{h-1}c_{h-1}=nm}$$
...
%    \begin{description}
%        \item[\underline{Paso $\bolds{p}$}] $\mbox{ }$
%        \begin{itemize}
%            \item $\bolds{b \mbox{ es par ($k_p\neq0$)}}$\\
%                \quad$\bolds{b\leftarrow b/2; c\leftarrow 2c \quad (k_p \mbox{ veces })}$
%            %\item $\bolds{b \mbox{ es impar ($k_p\neq0$)}}$\\
%        \end{itemize}
%        \quad$\bolds{a\leftarrow a+c; b\leftarrow b-1}$
%        \medskip
...
%    $$\bolds{a_p+b_pc_p=nm\mbox{ (inducci\'{o}n) }\Rightarrow\,\,\,a_p=nm\,\,\,(b_p=0)}$$

%    \noindent \underline{\underline{$\bolds{z\leftarrow a=nm}$}}

%    \vfill
%    %\noindent\rojo{$\bolds{b=0}$}

\subsection{Algoritmos de ordenaci\'{o}n}

El problema de \emph{ordenaci\'{o}n} es el siguiente:
    \begin{quotation}
        ``\emph{Dada una lista de n\'{u}meros enteros distintos }$\bolds{\{x_1,\,x_2,\ldots,\,x_n\}}$,
...
\vspace*{0.5cm}
 ...
 \vspace{0.2cm}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $1$\raisebox{1ex}{\underline{$\scriptstyle a$}\hspace*{.5ex}} comparaci\'{o}n:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        $\bolds{3\quad 7}$
        \end{minipage}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $2$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} comparaci\'{o}n:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        $\bolds{\quad\;\, 5\quad 7}$
        \end{minipage}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $3$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} comparaci\'{o}n:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $1$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} pasada:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $4$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} comparaci\'{o}n:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        $\bolds{3\quad 5}$
        \end{minipage}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $5$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} comparaci\'{o}n:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        $\bolds{\quad\;\, 1\quad 5}$
        \end{minipage}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $2$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} pasada:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        ...
        \begin{minipage}{.6\textwidth}
        Despu\'{e}s de la $6$\raisebox{1ex}{\underline{$\scriptstyle  a$}\hspace*{.5ex}} comparaci\'{o}n:
        \end{minipage}\hfill
        \begin{minipage}{.3\textwidth}
        $\bolds{1\quad 3}$
        \end{minipage}
...
%        \hspace*{0.3cm} $\bolds{y_{n-i+1}:=x_{n-i+1}}$; \\[1ex]
%        $\bolds{y_1:=x_1}$.
    \end{quotation}
...
%        \hspace*{0.3cm} $\bolds{j:=i}$;\\[1ex]
%        \hspace*{0.3cm} $\bolds{aux:=x_i}$;\\[1ex]
%        \hspace*{0.3cm} \textsf{Mientras} $\bolds{(j>1}$ \textsf{y} $\bolds{aux<x_{j-1})}$ \textsf{haz} \\[1ex]
%        \hspace*{0.8cm} $\bolds{x_j=x_{j-1}}$; \\[1ex]
%        \hspace*{0.8cm} $\bolds{x_{j-1}=aux}$; \\[1ex]
%        \hspace*{0.8cm} $\bolds{j=j-1}$; \\[1ex]
%        \hspace*{0.3cm} $\bolds{a_j=aux}$;
%    \end{quotation}
...
\vspace{0.2cm}
        ...
        Ordenemos la lista $\bolds{\{7, 3, 5, 1, 4, 6\}}$
\vspace{0.2cm}

        $\bolds{\{\emph{7}\}}$
        \medskip

        $\bolds{3\hookrightarrow\{7\}:}$\par
            $\bolds{\qquad 3<7 \Rightarrow \{3\;,\;7\}}$
        \medskip

        $\bolds{\{\emph{3}\;,\;\emph{7}\}}$
        \medskip

        $\bolds{5\hookrightarrow\{3\;\mid\;7\}:}$\par
            $\bolds{\qquad5<7\Rightarrow5\hookrightarrow\{3\}:}$\par
                    $\bolds{\qquad\qquad\qquad5>3\Rightarrow\{3\;,\;5\}}$
        \medskip


        $\bolds{\{\emph{3}\;,\;\emph{5}\;,\;\emph{7}\}}$
        \medskip

        $\bolds{1\hookrightarrow\{3\;,\;5\;\mid\;7\}:}$\par
            $\bolds{\qquad1<7\Rightarrow1\hookrightarrow\{3\;\mid\;5\}:}$\par
                $\bolds{\qquad\qquad1<5\Rightarrow1\hookrightarrow\{3\}:}$\par
                    $\bolds{\qquad\qquad\qquad1<3\Rightarrow\{1\;,\;3\}}$
        \medskip
...
%\item $\Leftrightarrow$ la curva {\textit lugar geom\'{e}trico de los
...
%{\textbf Ejemplo:}
%${\mathcal  P}(x)=\{\mbox{polinomios de grado menor o igual a n}\}$
%\begin{itemize}
%\item La base ${\mathcal  B}=\{1,x,\ldots,x^n\}$:
...
\begin{center}
\begin{tabular}{lr}
        \includegraphics[scale=0.35]{polinomioInterpolacion.pdf} \\  \includegraphics[scale=0.35]{local.pdf}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.2]{2_18.pdf} &  \includegraphics[scale=0.2]{2_19.pdf}
...
\begin{center}
\includegraphics[scale=0.5]{hermite.pdf}
\end{center}

Tal polinomio existe y es \'{u}nico (ver Cordero y Cort\'{e}s, {\textit Curvas y Superficies para el modelado geom\'{e}trico}, Ed. Ra-Ma)
...
\begin{center}
\begin{tabular}{lr}
\includegraphics[scale=0.35]{3_12a.pdf} &  \includegraphics[scale=0.35]{3_12b.pdf}\\
\end{tabular}
\end{center}

{\textbf Observaci\'{o}n:} En este dibujo los puntos $P_0^{(1)}, P_1^{(1)},P_2^{(1)},P_0^{(2)},P_1^{(2)}$ est\'{a}n fijados para $t=\frac{1}{3}.$
...
%
%\rojo{\textbf Algoritmo de De Casteljau}
%
%{\textbf Entrada:} $P_0,P_1,\ldots,P_n,$ puntos en $\mathbb{R}^2$ \'{o}
%$\mathbb{R}^3$
%
%{\textbf Salida:} $C(t)$
%
...
\subsubsection{Reparametrizaci�n:}
...
\begin{center}
\includegraphics[scale=0.55]{3_14.pdf}
\end{center}
...
%{\textbf Ejercicio:}
%Consideramos la curva compuesta por las dos curvas de B\'{e}zier simples generadas por los puntos de control $P_0=(0,0),\;P_1=(-1,1),\; P_2=(1,3)$ y %$Q_0=(1,3),\;Q_1=(2,4),\;Q_2=(5,1)$. ?`Es ${\mathcal  G}^1$? ?`Es ${\mathcal  C}^1$?
%
%\vfill
%
...
%que la que obten\'{\i}amos en el caso ${\mathcal  C}^1.$ \pause
